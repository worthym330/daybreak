              ...
              <div className="mb-12 max-w-[570px] lg:mb-0">
                ...
                <div className="mb-8 flex w-full max-w-[370px]">
                  ...
                  <div className="w-full">
                    ...
                    <p className="text-base text-body-color dark:text-dark-6">
                      <a href="tel:+918369029862">+91 8369029862</a>
                    </p>
                  </div>
                </div>
                ...
                <div className="mb-8 flex w-full max-w-[370px]">
                  ...
                  <div className="w-full">
                    ...
                    <p className="text-base text-body-color dark:text-dark-6">
                      <a href="mailto:team@daybreakpass.com">
  ...
  return (
    <div className="mb-6">
      ...
      <textarea
        ...
        onChange={setValues}
        name={name}
        className={`w-full resize-none rounded border px-[14px] py-3 text-base text-body-color outline-none focus:border-primary dark:border-dark-3 dark:bg-dark dark:text-dark-6 ${

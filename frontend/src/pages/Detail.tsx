          ...
          <div className="flex lg:flex-row flex-col gap-10 space-y-2 justify-between">
            <div className="flex flex-col gap-2 w-full lg:w-2/3">
              ...
              <div className="text-goldColor flex gap-4 items-center">
                ...
                <div>
                  <span className="text-base md:text-xl ">{hotel.star.toFixed(1)}</span>
                </div>
                {/* <div>
              ...
              <div className="w-full break-words mb-5 lg:hidden">
                ...
                <button onClick={toggleExpand} className="text-[#00C0CB] mt-2 text-sm md:text-base">
            ...
            <div className="">
              ...
              <span className="text-base md:text-lg font-medium">Select a product</span>
              <div className="mt-5">
              ...
              <div className="bg-gray-100 p-4 rounded-lg shadow-md mb-8">
                <h2 className="text-base md:text-lg font-medium mb-4">How it works</h2>
              ...
              <div className="w-full mx-auto p-4 text-justify bg-gray-100 rounded-lg shadow-md">
                ...
                <h3 className="text-sm md:text-lg font-medium mb-2">Cancel Online</h3>
